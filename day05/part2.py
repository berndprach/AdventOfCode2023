...
from part1 import (
    read_input,
    parse_lines,
    get_location_from_seed,
    CategoryMap,
    apply_category_map, CategoryToNext, CategoryMaps,
)

ValueRange = tuple[int, int]  # start, end+1


def get_intersection(range1: ValueRange,
                     range2: ValueRange
                     ) -> Optional[ValueRange]:
    # ..............s==========t...............
    # ..........s=================t............
...
def apply_category_map_to_range(category_map: CategoryMap,
    ...
    # Split:
    all_starts = [from_idx for _, from_idx, _ in category_map]
    all_ends = [from_idx + length for _, from_idx, length in category_map]
    ...
    for s, t in split_ranges:
        new_start = apply_category_map(category_map, s)
...
def solve(lines: list[str]) -> int:
    seed_data, category_to_next, category_maps = parse_lines(lines)
...
def get_location_from_seed_intervals(seed_intervals: list[ValueRange],
    ...
    while category != "location":
        ...
        total_length = sum([t - s for s, t in intervals])
